...
void OF_RGB::LedInit()
{
    ...
    // [ESP32_PORT] questa serve solo se nella board è integrato un neopixel e bisogna usare un'altro pin per abilitare o disabilitare il neopixel, non per inviare segnale al neopixel
